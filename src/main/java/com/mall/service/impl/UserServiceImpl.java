...
import com.mall.common.TokenCachel;
...
public class UserServiceImpl implements IUserService {
    ...
    public ServerResponse<String> checkAnswer(String username,String question,String answer){
        ...
        if (resultCount>0){
            ...
            TokenCachel.setKey(TokenCachel.TOKEN_PREFIX+username,forgetToken);
    ...
    public ServerResponse<String > forgetResetPassword(String username,String passwordNew,String forgetToken){
        ...
        String token = TokenCachel.getKey(TokenCachel.TOKEN_PREFIX+username);
    ...
    public ServerResponse<User> updateInfomation(User user){
        ...
        int countResult = userMapper.updateByPrimaryKeySelective(updateUser);
        if (countResult>0){
    ...
    public ServerResponse<User> getInfomation(Integer userId){
        User currnet = userMapper.selectByPrimaryKey(userId);
        if (currnet == null){
            return  ServerResponse.createByErrorMessage("找不到當前用戶");
        }
        currnet.setPassword(StringUtils.EMPTY);
        return ServerResponse.createBySuccess(currnet);
    }
    ...
    public ServerResponse checkAdminRole (User user){
        ...
        return ServerResponse.createByErrorMessage("不是管理员用户");
    }
